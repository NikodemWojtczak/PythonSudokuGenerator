...
for i in range(100):
    listOfSudokuEasy[i] = erase_random_numbers(30, listOfSudokuEasy[i])
    listOfSudokuMedium[i] = erase_random_numbers(47, listOfSudokuMedium[i])
    listOfSudokuHard[i] = erase_random_numbers(60, listOfSudokuHard[i])
